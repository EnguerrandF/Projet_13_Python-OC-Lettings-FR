...
def index(request):
    ...
    Praesent dictum, nulla eget feugiat sagittis, sem mi convallis eros, vitae dapibus nisi lorem dapibus sem. Maecenas pharetra purus ipsum, eget consequat ipsum lobortis quis.
    ...
    return render(request, 'app_oc_lettings_site/index.html')
